...
\begin{figure}[!h]
\centering
\includegraphics[width=2.8in]{resta3}
...
\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{escalar3}
...
\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{trans1}
...
\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{trans2}
...
\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{trans3}
...
%\hfill January 11, 2007
%% \subsection{Implementaci\'on}
%% El diagrama  (Fig.6), nos muestra el diagrama de flujo de ultimo nivel para obtener
%% la matriz transpuesta, la siguiente es la implementaci\'on en lenguaje ensamblador.
%% \begin{lstlisting}[language={[x86masm]Assembler}]
%% exit:
%%    mov   eax,1
%%    mov   ebx,0
