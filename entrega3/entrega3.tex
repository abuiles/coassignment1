...
\begin{abstract}
%\boldmath
En este tercer avance hicimos una refinaci\'on de cada uno de los problemas a
resolver
\end{abstract}
...
\section{Refinando los algoritmos}
% no \IEEEPARstart
Se realiza una refinaci\'on detallada de cada uno de los algoritmos, haciendo a un
nivel 3 de refinamiento
...
\subsection{Refinando la suma de matrices}
Se muestra una refinaci\'on para el problema de sumas dos matrices


\subsubsection{Vista general}
Aqu\'i se muestra una vista muy general de como funciona el algoritmo para sumar las
matrices.
\begin{figure}[!h]
\centering
\includegraphics[width=2.5in]{sumaParte1}
...
\begin{figure}[h]
\centering
\includegraphics[width=2in]{suma2}
\caption{Suma de matrices}
\label{fig_sim}
\end{figure}
...
leer los valores iniciales y la parte de recorrer las dos matrices realizando su suma.
\begin{figure}[h]
\centering
\includegraphics[width=2in]{suma3}
\caption{Suma de matrices}
\label{fig_sim}
\end{figure}

\subsection{Refinando la resta de matrices}
Se muestra una refinaci\'on para el problema de resta de dos matrices
